...
Извините, у меня почему-то сейчас не работают библиотеки, хотя, когда выполняла дз, все было хорошо - сегодня хотела доделать 1.5 задание, запустила код и все сломалось :( . Пока загружу так, а как разберусь в причине, если успею, доделаю.
